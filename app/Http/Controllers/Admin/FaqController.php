...
class FaqController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $items = FaqService::search($request, $items);
    ...
    public function update(FaqRequest $request, Faq $faq)
    {
        ...
        $user = $this->faqService->update($input, $faq->id);
        return redirect()->route($this->index_route)
    ...
    {
        return (new FaqExport($request))->download($request->export == 'excel' ? 'faqs.xlsx' : 'faqs.csv');
    }
}
