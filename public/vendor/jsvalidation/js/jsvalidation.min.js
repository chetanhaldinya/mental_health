...
!(function (e) {
    ...
    h.extend(h.fn, {
                    ...
                    : (this.attr("novalidate", "novalidate"),
                      ...
                      i.settings.onsubmit &&
                          ...
                          this.on("submit.validate", function (a) {
                              ...
                              return (
                                  i.settings.debug && a.preventDefault(),
                                  i.cancelSubmit
                                      ? ((i.cancelSubmit = !1), e())
                                      : i.form()
                                      ? i.pendingRequest
        ...
        rules: function (e, t) {
            ...
            if (
                ...
                if (e)
                    switch (
                        ((i = (a = h.data(l.form, "validator").settings).rules),
                ...
                return (
                    (n = h.validator.normalizeRules(
                        ...
                        ((s = n.required),
                        delete n.required,
                        (n = h.extend({ required: s }, n))),
                    n.remote &&
                        ((s = n.remote),
                        delete n.remote,
                        (n = h.extend(n, { remote: s }))),
                    n
                );
            }
        },
        ...
        h.extend(h.validator, {
            ...
            prototype: {
                        ...
                        .filter(function () {
                            ...
                            return (
                                ...
                                t &&
                                    ((this.form = h(this).closest("form")[0]),
                                    (this.name = e)),
                                this.form === a.currentForm &&
                                    !(
                                        e in i ||
                                        !a.objectLength(h(this).rules())
                                    ) &&
                                    (i[e] = !0)
                            );
                        });
                ...
                check: function (t) {
                    ...
                    for (a in ("function" == typeof n.normalizer
                        ? (r = n.normalizer)
                        : "function" == typeof this.settings.normalizer &&
                          (r = this.settings.normalizer),
                    r && ((l = r.call(t, l)), delete n.normalizer),
                    n)) {
                        i = { method: a, parameters: n[a] };
                        try {
                            if (
                                "dependency-mismatch" ===
                                    (e = h.validator.methods[a].call(
                                        this,
                                        l,
                                        t,
                                        i.parameters
                ...
                defaultShowErrors: function () {
                    ...
                    if (this.settings.unhighlight)
                        for (a = 0, e = this.validElements(); e[a]; a++)
                            this.settings.unhighlight.call(
                                this,
                                e[a],
                                this.settings.errorClass,
                    ...
                    s.length
                        ...
                        : ((a = s =
                          ...
                          this.labelContainer.length
                              ...
                              ? this.settings.errorPlacement.call(this, a, h(e))
                              : a.insertAfter(e),
                          s.is("label")
                              ? s.attr("for", o)
                              : 0 ===
                    ...
                    return (
                        a &&
                            (i =
                                i +
                                ", #" +
                                this.escapeCssMeta(a).replace(/\s+/g, ", #")),
                    ...
                    this.pendingRequest--,
                        ...
                        this.form()
                            ...
                            : !t &&
                              0 === this.pendingRequest &&
                              this.formSubmitted &&
                              (h(this.currentForm).triggerHandler(
                                  "invalid-form",
                                  [this]
                              ),
                              (this.formSubmitted = !1));
            ...
            classRules: function (e) {
                ...
                return (
                    a &&
                        h.each(a.split(" "), function () {
                            this in h.validator.classRuleSettings &&
                                h.extend(
                                    t,
                                    h.validator.classRuleSettings[this]
                                );
                        }),
                    t
                );
            ...
            attributeRules: function (e) {
                ...
                for (t in h.validator.methods)
                    (a =
                        "required" === t
                            ? ("" === (a = e.getAttribute(t)) && (a = !0), !!a)
                            : r.attr(t)),
                        this.normalizeAttributeRule(i, n, t, a);
                return (
                    i.maxlength &&
            ...
            staticRules: function (e) {
                ...
                return (
                    a.settings.rules &&
                        (t =
                            h.validator.normalizeRule(
                                a.settings.rules[e.name]
                            ) || {}),
                    t
                );
            },
            normalizeRules: function (i, r) {
                return (
                    ...
                    h.each(i, function (e, t) {
                        i[e] =
                            "function" == typeof t && "normalizer" !== e
                                ? t(r)
                                : t;
                    }),
            ...
            addMethod: function (e, t, a) {
                (h.validator.methods[e] = t),
                    (h.validator.messages[e] =
                        void 0 !== a ? a : h.validator.messages[e]),
                    t.length < 3 &&
    ...
    return (
        h.ajaxPrefilter
            ? h.ajaxPrefilter(function (e, t, a) {
                  var i = e.port;
    ...
    (function (e, t) {
        ...
        var b = {
                ...
                lpad: function (e, t, a) {
                    var i = e.toString();
                    return (a = a || "0"), i.length < t ? b.lpad(a + i, t) : i;
                },
                merge: function (e) {
                    var t, a;
        ...
        return (
            (e.prototype = {
                constructor: e,
                getMonth: function (e) {
                    var t = b.getIndex(e, this.dateSettings.monthsShort) + 1;
                    return (
                        0 === t &&
                            (t = b.getIndex(e, this.dateSettings.months) + 1),
                        t
                    );
                },
                parseDate: function (e, t) {
                    ...
                    if ("U" === t)
                        return (r = b.getInt(e)) ? new Date(1e3 * r) : e;
                    switch (typeof e) {
                        case "number":
                            return new Date(e);
                        case "string":
                    ...
                    if (!(a = t.match(this.validParts)) || 0 === a.length)
                        throw new Error("Invalid date format definition.");
                    for (r = a.length - 1; 0 <= r; r--)
                        "S" === a[r] && a.splice(r, 1);
                    for (
                        i = e.replace(this.separators, "\0").split("\0"), r = 0;
                        r < i.length;
                        r++
                    )
                        switch (((n = i[r]), (s = b.getInt(n)), a[r])) {
                            case "y":
                            case "Y":
                                if (!s) return null;
                                (h = n.length),
                            ...
                            case "h":
                                if (
                                    ...
                                    (u = b.compare(d, f.meridiem[0])
                                        ? 0
                                        : b.compare(d, f.meridiem[1])
                                        ? 12
                                        : -1),
                                        1 <= s && s <= 12 && -1 != u
                                            ? (g.hour = s % 12 == 0 ? u : s + u)
                    ...
                    if (!0 === c) {
                        var p = g.year || 0,
                            v = g.month ? g.month - 1 : 0,
                            y = g.day || 1;
                        g.date = new Date(p, v, y, g.hour, g.min, g.sec, 0);
                    } else {
                        if (!0 !== m) return null;
                ...
                parseFormat: function (e, i) {
                    ...
                    var a = this,
                        ...
                        s = {
                            ...
                            B: function () {
                                var e = i.getUTCHours() * b.HOUR,
                                    t = 60 * i.getUTCMinutes(),
                                    a = i.getUTCSeconds();
                                return b.lpad(
                                    Math.floor((e + t + a + b.HOUR) / 86.4) %
                                        1e3,
                                    3
                                );
                            },
                            ...
                            i: function () {
                                return b.lpad(i.getMinutes(), 2);
                            },
                            s: function () {
                                return b.lpad(i.getSeconds(), 2);
                            },
                            u: function () {
                                return b.lpad(1e3 * i.getMilliseconds(), 6);
                            },
                            e: function () {
                                return (
                                    /\((.*)\)/.exec(String(i))[1] ||
                    ...
                    if (e instanceof Date) {
                        for (r = t.length, a = 0; a < r; a++)
                            "S" !== (s = t.charAt(a)) &&
                                ...
                                (0 < a && "\\" === t.charAt(a - 1)
                                    ? (o += s)
                                    : ((n = this.parseFormat(s, e)),
                                      a !== r - 1 &&
                                          this.intParts.test(s) &&
                                          "S" === t.charAt(a + 1) &&
                                          ((i = b.getInt(n) || 0),
                                          (n += this.dateSettings.ordinal(i))),
                                      (o += n)));
                        return o;
                    }
                    return "";
    ...
    (laravelValidation = {
        ...
        init: function () {
            ...
            ($.fn.validate = function (e) {
                var t = "proengsoft_jsvalidation";
                return (
                    0 === $(this).find('input[name="' + t + '"]').length &&
                        $("<input>")
                            .attr({ type: "hidden", name: t })
                            .appendTo(this),
                    a.apply(this, [e])
                );
            }),
        ...
        arrayRules: function (r) {
            var n = {},
                e = $.data(r.form, "validator"),
                s = e.arrayRulesCache;
            return (
                -1 === r.name.indexOf("[") ||
                    (r.name in s || (s[r.name] = {}),
                    $.each(e.settings.rules, function (e, t) {
                        var a, i;
                        e in s[r.name]
                            ? (n = laravelValidation.helpers.mergeRules(
                                  n,
                                  s[r.name][e]
                              ))
                            : ((s[r.name][e] = {}),
                              (a =
                                  laravelValidation.helpers.regexFromWildcard(
                                      e
                                  )),
                              r.name.match(a) &&
                                  ((i = $.validator.normalizeRule(t) || {}),
                                  (s[r.name][e] = i),
                                  (n = laravelValidation.helpers.mergeRules(
                                      n,
                                      i
        ...
        setupValidations: function () {
            function r(e) {
                ...
                return (
                    $(e.currentForm).find('input[name="_method"]').length &&
                        (t = $(e.currentForm)
            ...
            function h(a, e, i, t) {
                return {
                    ...
                    url: $(a.currentForm).attr("action"),
                    type: r(a),
                    beforeSend: function (e) {
                        var t = i[0][1][1];
                        if ("get" !== r(a) && t)
                            return e.setRequestHeader("X-XSRF-TOKEN", t);
                    },
                };
            }
            function l(s, i, o, e) {
                ...
                return (
                    $.each(e, function (e, t) {
                        var a =
                            ...
                            r = t[0],
                            n = t[2];
                        return !a && s.optional(o)
                            ? !(l = "dependency-mismatch")
                            : (void 0 !== laravelValidation.methods[r]
                                  ? $.each(i, function (e, i) {
                                        if (
                                            !1 ===
                                            (l = laravelValidation.methods[
                                                r
                                            ].call(s, i, o, t[1], function (e) {
                                                var t, a;
                                                (s.settings.messages[
                                                    o.name
            ...
            $.validator.addMethod(
                ...
                $.validator.addMethod(
                    ...
                    function (s, o, e) {
                        ...
                        return (
                            ...
                            (this.settings.messages[
                                o.name
                            ].laravelValidationRemote = u.message),
                            laravelValidation.helpers.arrayEquals(u.old, s) ||
                            u.old === s
                                ? u.valid
                                : ((u.old = s),
                                  (l = this).startRequest(o),
                                  (i = $(l.currentForm).serializeArray()).push({
                                      name: "_jsvalidation",
                                      value: o.name,
                                  }),
                                  i.push({
                                  ...
                                  $.ajax(h(l, o, e, i)).always(function (e, t) {
                                      var a, i, r, n;
                                      if ("error" === t)
                                          (n = !1),
                                              (e =
                ...
                $.validator.addMethod(
                    ...
                    function (e, r, t) {
                        var n = this,
                            s = n.previousValue(r),
                            a = $(n.currentForm).serializeArray();
                        return (
                            a.push({
                                name: "__proengsoft_form_request",
                                value: 1,
                            }),
                            JSON.stringify(s.old) === JSON.stringify(a)
                                ? (s.valid || n.showErrors(s.errors || {}),
                                  s.valid)
                                : ((s.old = a),
                                  this.startRequest(r),
                                  $.ajax(h(n, r, t, a)).always(function (e, t) {
                                      var i = {},
                                          a =
                                              "success" === t &&
                                              (!0 === e || "true" === e);
    ...
    (function () {
        "use strict";
        var i = {
                "./node_modules/locutus/php/array/array_diff.js": function (e) {
                ...
                "./node_modules/locutus/php/datetime/strtotime.js": function (
                    e
                ) {
                    var t = "[ \\t]+",
                        a = "[ \\t]*",
                    ...
                    var $ = {
                        ...
                        D = {
                            ...
                            timeLong12: {
                                ...
                                name: "timelong12",
                                callback: function (e, t, a, i, r) {
                                    return this.time(T(+t, r), +a, +i, 0);
                                },
                            },
                            timeShort12: {
                                regex: RegExp(
                                ...
                                name: "timeshort12",
                                callback: function (e, t, a, i) {
                                    return this.time(T(+t, i), +a, 0, 0);
                                },
                            },
                            timeTiny12: {
                                regex: RegExp("^" + s + a + i, "i"),
                                name: "timetiny12",
                                callback: function (e, t, a) {
                                    return this.time(T(+t, a), 0, 0, 0);
                                },
                            },
                            soap: {
                                regex: RegExp(
                                ...
                                name: "soap",
                                callback: function (e, t, a, i, r, n, s, o, l) {
                                    return (
                                        this.ymd(+t, a - 1, +i) &&
                                        this.time(
                                            +r,
                            ...
                            wddx: {
                                ...
                                name: "wddx",
                                callback: function (e, t, a, i, r, n, s) {
                                    return (
                                        this.ymd(+t, a - 1, +i) &&
                                        this.time(+r, +n, +s, 0)
                                    );
                            ...
                            clf: {
                                ...
                                name: "clf",
                                callback: function (e, t, a, i, r, n, s, o) {
                                    return (
                                        this.ymd(+i, j(a), +t) &&
                                        this.time(+r, +n, +s, 0) &&
                                        this.zone(z(o))
                            ...
                            dayText: {
                                ...
                                callback: function (e, t) {
                                    this.resetTime(),
                                        (this.weekday = _(t, 0)),
                                        2 !== this.weekdayBehavior &&
                                            (this.weekdayBehavior = 1);
                                },
                            },
                            relativeTextWeek: {
                                regex: RegExp("^(" + p + ")" + t + "week", "i"),
                        ...
                        M = {
                            ...
                            toDate: function (e) {
                                switch (
                                    ...
                                    isNaN(this.y) && (this.y = e.getFullYear()),
                                    isNaN(this.m) && (this.m = e.getMonth()),
                                    isNaN(this.d) && (this.d = e.getDate()),
                                    isNaN(this.h) && (this.h = e.getHours()),
                                    isNaN(this.i) && (this.i = e.getMinutes()),
                                    isNaN(this.s) && (this.s = e.getSeconds()),
                                    isNaN(this.f) &&
                                        (this.f = e.getMilliseconds()),
                                ...
                                var t, a, i;
                                isNaN(this.weekday) ||
                                    ((t = new Date(e.getTime())).setFullYear(
                                        this.y,
                                        this.m,
                                        this.d
                                    ),
                                    t.setHours(this.h, this.i, this.s, this.f),
                                    (a = t.getDay()),
                                    2 === this.weekdayBehavior
                                        ? (0 === a &&
                                              0 !== this.weekday &&
                                ...
                                switch (
                                    (r.setFullYear(this.y, this.m, this.d),
                                    r.setHours(this.h, this.i, this.s, this.f),
                                    this.firstOrLastDayOfMonth)
                                ) {
                                    case 1:
                                        r.setDate(1);
                    ...
                    e.exports = function (e, t) {
                        ...
                        for (
                            var a = [
                                    ...
                                    D.relativeTextWeek,
                                    D.relativeText,
                                    D.monthFullOrMonthAbbr,
                                    D.tzCorrection,
                                    D.tzAbbr,
                                    D.dateShortWithTimeShort12,
                                    D.dateShortWithTimeLong12,
                                    D.dateShortWithTimeShort,
                                    D.dateShortWithTimeLong,
                                    D.relative,
                                    D.whitespace,
                                ],
                                i = Object.create(M);
                            ...
                            for (
                                var r = null, n = null, s = 0, o = a.length;
                                s < o;
                                s++
                            ) {
                                var l = a[s],
                                    u = e.match(l.regex);
                                u &&
                                    (!r || u[0].length > r[0].length) &&
                                    ((r = u), (n = l));
                            }
                            if (
                                !n ||
                                (n.callback && !1 === n.callback.apply(i, r))
                            )
                                return !1;
                            (e = e.substr(r[0].length)), (r = n = null);
                        }
                        return Math.floor(i.toDate(new Date(1e3 * t)) / 1e3);
                    };
                },
                "./node_modules/locutus/php/info/ini_get.js": function (
                    e,
                    t,
                    i
                ) {
                    e.exports = function (e) {
                        var t = "undefined" != typeof window ? window : i.g;
                        t.$locutus = t.$locutus || {};
                        var a = t.$locutus;
                        return (
                            (a.php = a.php || {}),
                            (a.php.ini = a.php.ini || {}),
                            !a.php.ini[e] ||
                            void 0 === a.php.ini[e].local_value ||
                            null === a.php.ini[e].local_value
                                ? ""
                                : a.php.ini[e].local_value
                        );
                    };
                },
                "./node_modules/locutus/php/strings/strlen.js": function (
                    e,
                    t,
                    r
                ) {
                    e.exports = function (e) {
                        ...
                        if (
                            "off" ===
                            (r("./node_modules/locutus/php/info/ini_get.js")(
                                "unicode.semantics"
                            ) || "off")
                        )
                            return t.length;
                ...
                "./node_modules/locutus/php/var/is_numeric.js": function (e) {
                    e.exports = function (e) {
                        var t = [
                            " ",
                            "\n",
        ...
        !(function () {
            l.r(u);
            var e = l("./node_modules/locutus/php/strings/strlen.js"),
                t = l.n(e),
                a = l("./node_modules/locutus/php/array/array_diff.js"),
                i = l.n(a),
                r = l("./node_modules/locutus/php/datetime/strtotime.js"),
                n = l.n(r),
                s = l("./node_modules/locutus/php/var/is_numeric.js"),
                o = l.n(s);
                ...
                helpers: {
                    ...
                    hasRules: function (e, r) {
                        ...
                        return (
                            ...
                            e.name in t.settings.rules &&
                                a.push(t.settings.rules[e.name]),
                            $.each(a, function (e, t) {
                                if ("laravelValidation" in t)
                                    for (
                                        var a = t.laravelValidation, i = 0;
                                        i < a.length;
                                        i++
                                    )
                                        if (-1 !== $.inArray(a[i][0], r))
                                            return !(n = !0);
                            }),
                            n
                        );
                    ...
                    getLaravelValidation: function (a, e) {
                        var i = void 0;
                        return (
                            $.each($.validator.staticRules(e), function (e, t) {
                                "laravelValidation" === e &&
                                    $.each(t, function (e, t) {
                                        t[0] === a && (i = t);
                                    });
                    ...
                    parseTime: function (e, t) {
                        var a,
                            i = !1,
                            r = new DateFormatter();
                        return "number" == typeof e && void 0 === t
                            ? e
                            : ("object" == typeof t &&
                                  (t =
                                      void 0 !==
                                      (a = this.getLaravelValidation(
                                          "DateFormat",
                                          t
                                      ))
                                          ? a[1][0]
                              ...
                              (i =
                                  null == t
                                      ? this.strtotime(e)
                                      : (i = r.parseDate(e, t)) &&
                                        Math.round(i.getTime() / 1e3)));
                    },
                    compareDates: function (e, t, a, i, r) {
                        var n = this.parseTime(i);
                        if (!n) {
                        ...
                        return (
                            void 0 !== n[0] &&
                                ...
                                ("SELECT" !== n[0].tagName &&
                                    ...
                                    "radio" !== n[0].type) ||
                                    (i = "click"),
                                (r = ".validate-laravelValidation"),
                                n
                                    .off(r)
                                    .off(i + r + "-" + t.name)
                                    .on(i + r + "-" + t.name, function () {
                                        $(t).valid();
                                    })),
                            n[0]
                        );
                    ...
                    findByArrayName: function (e, t) {
                        for (
                            ...
                            var n = e.findByName(i[r]);
                            if (0 < n.length) return n;
                        }
                        return $(null);
                    },
                    findByName: function (e, t) {
                        var a = e.findByName(t);
                        if (0 < a.length) return a;
                        for (var i = t.split("."), r = i.length; 0 < r; r--) {
                            for (var n = [], s = 0; s < r; s++) n.push(i[s]);
                            if (
                                0 <
                                (a = this.findByArrayName(e, n.join(".")))
                                    .length
                            )
                                return a;
                        }
                    ...
                    allElementValues: function (a, e) {
                        return -1 !== e.name.indexOf("[]")
                            ? a
                                  .findByName(e.name)
                                  .map(function (e, t) {
                                      return a.elementValue(t);
                                  })
                                  .get()
                            : a.elementValue(e);
                    },
        ...
        helpers: {
            isTimezone: function (e) {
                ...
                return (
                    ...
                    i in t && (0 === t[i].length || -1 !== t[i].indexOf(r))
                );
            },
        },
    }),
    $.extend(!0, laravelValidation, {
        methods: {
            ...
            RequiredWith: function (e, i, t) {
                var r = this,
                    n = !1,
                    s = this;
                return (
                    $.each(t, function (e, t) {
                        var a = laravelValidation.helpers.dependentElement(
                            s,
                            i,
                            t
                        );
            ...
            RequiredWithAll: function (e, i, t) {
                var r = this,
                    n = !0,
                    s = this;
                return (
            ...
            RequiredWithout: function (e, i, t) {
                var r = this,
                    n = !1,
                    s = this;
                return (
            ...
            RequiredWithoutAll: function (e, i, t) {
                var r = this,
                    n = !0,
                    s = this;
                return (
            ...
            RequiredIf: function (e, t, a) {
                var i = laravelValidation.helpers.dependentElement(
                    this,
                    t,
                    a[0]
                );
            ...
            Same: function (e, t, a) {
                ...
                return (
                    void 0 !== i && String(e) === String(this.elementValue(i))
                );
            },
            InArray: function (e, t, a) {
                ...
                for (
                    var i = this.elements(),
                        r = !1,
                        n = laravelValidation.helpers.regexFromWildcard(a[0]),
                        s = 0;
                    s < i.length;
                    s++
                ) {
                    var o,
                        l = i[s].name;
                    l.match(n) &&
                        ((o = laravelValidation.methods.Same.call(this, e, t, [
                            l,
                        ])),
                        (r = r || o));
                }
            ...
            Array: function (e, t) {
                return (
                    (-1 !== t.name.indexOf("[") &&
                        -1 !== t.name.indexOf("]")) ||
                    laravelValidation.helpers.isArray(e)
                );
            },
            Boolean: function (e) {
            ...
            Min: function (e, t, a) {
                return (
                    (e = laravelValidation.helpers.allElementValues(this, t)),
                    laravelValidation.helpers.getSize(this, t, e) >=
                        parseFloat(a[0])
                );
            },
