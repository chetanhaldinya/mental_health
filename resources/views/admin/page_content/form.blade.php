...
<div class="card-body">
    ...
    <div class="row mb-6">
        ...
        <!--begin::Col-->
        <div class="col-lg-10 fv-row">
            {!! Form::textarea('content', null, ['class' => 'form-control form-control-lg form-control-solid mb-3 mb-lg-0 ckeditor', 'id' => 'ckeditor', 'rows' => 3, 'cols' => 40, 'placeholder' => __('placeholder.content_title')]) !!}
